<aside id="cookies-policy" class="cookies fixed w-full flex " data-text="{{ json_encode(__('cookieConsent::cookies
.details'))
}}">
    <div class="w-full bg-purple-50 flex flex-col justify-center items-center px-20 pt-12">
        <div class="">
            <div class="cookies__wrapper">
                <h2 class="text-base leading-6 font-bold text-orange-500 text-lg">@lang('cookieConsent::cookies.title')</h2>
                <div class="text-base leading-6 font-light">
